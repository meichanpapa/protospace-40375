...
ActiveRecord::Schema[7.0].define(version: 2024_03_09_081546) do
  ...
  create_table "users", charset: "utf8", collation: "utf8_general_mysql500_ci", force: :cascade do |t|
    ...
    t.text "profile", collation: "utf8_general_ci"
    t.text "occupation", collation: "utf8_general_ci"
    t.text "position", collation: "utf8_general_ci"
